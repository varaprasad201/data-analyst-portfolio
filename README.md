...
**Analytics**: Advanced Excel (Power Query, Power Pivot, VBA) • SQL (CTEs, Window Functions, Joins) • Power BI (DAX, ETL, RLS) • Python (Pandas, NumPy, Matplotlib)
